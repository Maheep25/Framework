...
public class StandAloneTest2_HashMap extends BaseTest {
...
//	String productName = "ZARA";
	...
	public Object[][] dataJson()
	{
		...
		map.put("user", "msd7@gmail.com");
		map.put("password", "Qwerty@123");
		map.put("productName", "ZARA");
		
		HashMap<String, String> map_2 = new HashMap<String, String>();
		map_2.put("user", "msd7@gmail.com");
		map_2.put("password", "Qwerty@123");
		map_2.put("productName", "ZARA");
		
		return new Object [] [] {{map}, {map_2}};
	}
	
	@Test(dependsOnMethods = {"order_info"})
	public void message()
	{
		System.out.println("This TC is with HashMap");
	}
